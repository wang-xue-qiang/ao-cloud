...
import com.zkh.cloud.utils.string.ObjectUtils;
   ...
   // redis过期时间,以秒为单位 
	...
	static {
		if(jedisPool == null) {
			...
			jedisPool = new JedisPool(config, "39.105.200.153", 6379,  5000);
		}
	}
    
	/**
	 * @Description: 根据key获取缓存返回字符串
	 * @param key
	 * @return
	 */
